...
const OptionBar = (props) => {
    const { refetch, updateDuration, setWords } = props;
    ...
    return (
        <Flex rounded='8px' className='options-bar' padding="16px" alignItems={"center"} justifyContent={"center"}>
            <Box gap="8px" onClick={refetch} width="100%" display="flex" alignItems={"center"} justifyContent={"center"} stroke="#646669" _hover={{ bg: "transparent", stroke: "#FCFCFC", color: "#FCFCFC" }}>
